...
static PyCodeObject *codeobj_32111e55136127b57d8f5031789a4683;
static PyCodeObject *codeobj_45158877746db9ce826117149d3f8782;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_32111e55136127b57d8f5031789a4683 = MAKE_CODE_OBJECT(module_filename_obj, 265, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[61], mod_consts[61], mod_consts[171], NULL, 1, 0, 0);
    codeobj_45158877746db9ce826117149d3f8782 = MAKE_CODE_OBJECT(module_filename_obj, 269, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[61], mod_consts[61], mod_consts[184], NULL, 2, 0, 0);
}
...
static PyObject *impl_dateutil$relativedelta$$$function__3_weeks(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Local variable declarations.
    PyObject *par_self = python_pars[0];
    struct Nuitka_FrameObject *frame_32111e55136127b57d8f5031789a4683;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *tmp_return_value = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    NUITKA_MAY_BE_UNUSED int exception_lineno = 0;
    static struct Nuitka_FrameObject *cache_frame_32111e55136127b57d8f5031789a4683 = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_32111e55136127b57d8f5031789a4683)) {
        Py_XDECREF(cache_frame_32111e55136127b57d8f5031789a4683);

#if _DEBUG_REFCOUNTS
        if (cache_frame_32111e55136127b57d8f5031789a4683 == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_32111e55136127b57d8f5031789a4683 = MAKE_FUNCTION_FRAME(tstate, codeobj_32111e55136127b57d8f5031789a4683, module_dateutil$relativedelta, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    assert(cache_frame_32111e55136127b57d8f5031789a4683->m_type_description == NULL);
    frame_32111e55136127b57d8f5031789a4683 = cache_frame_32111e55136127b57d8f5031789a4683;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_32111e55136127b57d8f5031789a4683);
    assert(Py_REFCNT(frame_32111e55136127b57d8f5031789a4683) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_32111e55136127b57d8f5031789a4683, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_32111e55136127b57d8f5031789a4683->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_32111e55136127b57d8f5031789a4683, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_32111e55136127b57d8f5031789a4683,
        type_description_1,
        par_self
    );
    ...
    // Release cached frame if used for exception.
    if (frame_32111e55136127b57d8f5031789a4683 == cache_frame_32111e55136127b57d8f5031789a4683) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_32111e55136127b57d8f5031789a4683);
        cache_frame_32111e55136127b57d8f5031789a4683 = NULL;
    }

    assertFrameObject(frame_32111e55136127b57d8f5031789a4683);
...
static PyObject *impl_dateutil$relativedelta$$$function__4_weeks(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_45158877746db9ce826117149d3f8782;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    NUITKA_MAY_BE_UNUSED int exception_lineno = 0;
    bool tmp_result;
    static struct Nuitka_FrameObject *cache_frame_45158877746db9ce826117149d3f8782 = NULL;
    PyObject *tmp_return_value = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_45158877746db9ce826117149d3f8782)) {
        Py_XDECREF(cache_frame_45158877746db9ce826117149d3f8782);

#if _DEBUG_REFCOUNTS
        if (cache_frame_45158877746db9ce826117149d3f8782 == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_45158877746db9ce826117149d3f8782 = MAKE_FUNCTION_FRAME(tstate, codeobj_45158877746db9ce826117149d3f8782, module_dateutil$relativedelta, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    assert(cache_frame_45158877746db9ce826117149d3f8782->m_type_description == NULL);
    frame_45158877746db9ce826117149d3f8782 = cache_frame_45158877746db9ce826117149d3f8782;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_45158877746db9ce826117149d3f8782);
    assert(Py_REFCNT(frame_45158877746db9ce826117149d3f8782) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_45158877746db9ce826117149d3f8782, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_45158877746db9ce826117149d3f8782->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_45158877746db9ce826117149d3f8782, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_45158877746db9ce826117149d3f8782,
        type_description_1,
        par_self,
        par_value
    );
    ...
    // Release cached frame if used for exception.
    if (frame_45158877746db9ce826117149d3f8782 == cache_frame_45158877746db9ce826117149d3f8782) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_45158877746db9ce826117149d3f8782);
        cache_frame_45158877746db9ce826117149d3f8782 = NULL;
    }

    assertFrameObject(frame_45158877746db9ce826117149d3f8782);
...
static PyObject *MAKE_FUNCTION_dateutil$relativedelta$$$function__3_weeks() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        mod_consts[138],
#endif
        codeobj_32111e55136127b57d8f5031789a4683,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
static PyObject *MAKE_FUNCTION_dateutil$relativedelta$$$function__4_weeks() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        mod_consts[138],
#endif
        codeobj_45158877746db9ce826117149d3f8782,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
