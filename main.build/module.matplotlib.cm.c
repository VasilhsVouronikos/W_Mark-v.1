...
static PyObject *impl_matplotlib$cm$$$function__2__gen_cmap_registry(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Framed code:
    {
...

        {
            ...
            tmp_assign_source_1 = impl___main__$$$function__18__unpack_dict(tstate, dir_call_args);
        }
...
static PyObject *impl_matplotlib$cm$$$function__32_norm(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_12eb57922d35612227a7dd2bfe055919)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_12eb57922d35612227a7dd2bfe055919 = MAKE_FUNCTION_FRAME(tstate, codeobj_12eb57922d35612227a7dd2bfe055919, module_matplotlib$cm, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_12eb57922d35612227a7dd2bfe055919);
...
static PyObject *impl_matplotlib$cm$$$function__33_norm(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_587fb685495f8cc85dc0ecae70981b09)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_587fb685495f8cc85dc0ecae70981b09 = MAKE_FUNCTION_FRAME(tstate, codeobj_587fb685495f8cc85dc0ecae70981b09, module_matplotlib$cm, sizeof(nuitka_bool)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_587fb685495f8cc85dc0ecae70981b09);
...
// Mark the execution in the "__spec__" value.
    ...
    // Tried code:
    {
        ...
        // Tried code:
        // Tried code:
        frame_e89b7ea872c34488bbb21cace41060bb_2 = MAKE_CLASS_FRAME(tstate, codeobj_e89b7ea872c34488bbb21cace41060bb, module_matplotlib$cm, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(tstate, frame_e89b7ea872c34488bbb21cace41060bb_2);
