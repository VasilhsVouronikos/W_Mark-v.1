...
static void createModuleCodeObjects(void) {
    ...
    codeobj_31a16972c0d1c381659422ef5850bdf1 = MAKE_CODE_OBJECT(module_filename_obj, 164, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[122], mod_consts[122], mod_consts[132], NULL, 10, 0, 0);
...
static PyObject *impl_matplotlib$tight_layout$$$function__2_auto_adjust_subplotpars(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_31a16972c0d1c381659422ef5850bdf1)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_31a16972c0d1c381659422ef5850bdf1 = MAKE_FUNCTION_FRAME(tstate, codeobj_31a16972c0d1c381659422ef5850bdf1, module_matplotlib$tight_layout, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_31a16972c0d1c381659422ef5850bdf1);
