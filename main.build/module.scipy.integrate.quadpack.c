...
static void createModuleConstants(PyThreadState *tstate) {
    if (constants_created == false) {
        loadConstantsBlob(tstate, &mod_consts[0], UNTRANSLATE("scipy.integrate.quadpack"));
...
static PyCodeObject *codeobj_33253e98aabcee15fdc115128557f81d;
static PyCodeObject *codeobj_394b6387dbdf916e27176e01f036cd63;
static PyCodeObject *codeobj_31f00f2dd5739ea1220896d79e534157;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[24]); CHECK_OBJECT(module_filename_obj);
    codeobj_33253e98aabcee15fdc115128557f81d = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[25], mod_consts[25], NULL, NULL, 0, 0, 0);
    codeobj_394b6387dbdf916e27176e01f036cd63 = MAKE_CODE_OBJECT(module_filename_obj, 18, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[22], mod_consts[22], NULL, NULL, 0, 0, 0);
    codeobj_31f00f2dd5739ea1220896d79e534157 = MAKE_CODE_OBJECT(module_filename_obj, 22, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[23], mod_consts[23], mod_consts[26], NULL, 1, 0, 0);
}
...
static PyObject *impl_scipy$integrate$quadpack$$$function__1___dir__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_394b6387dbdf916e27176e01f036cd63;
    ...
    static struct Nuitka_FrameObject *cache_frame_394b6387dbdf916e27176e01f036cd63 = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_394b6387dbdf916e27176e01f036cd63)) {
        Py_XDECREF(cache_frame_394b6387dbdf916e27176e01f036cd63);

#if _DEBUG_REFCOUNTS
        if (cache_frame_394b6387dbdf916e27176e01f036cd63 == NULL) {
...
#endif
        cache_frame_394b6387dbdf916e27176e01f036cd63 = MAKE_FUNCTION_FRAME(tstate, codeobj_394b6387dbdf916e27176e01f036cd63, module_scipy$integrate$quadpack, 0);
#if _DEBUG_REFCOUNTS
    } else {
    ...
    assert(cache_frame_394b6387dbdf916e27176e01f036cd63->m_type_description == NULL);
    frame_394b6387dbdf916e27176e01f036cd63 = cache_frame_394b6387dbdf916e27176e01f036cd63;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_394b6387dbdf916e27176e01f036cd63);
    assert(Py_REFCNT(frame_394b6387dbdf916e27176e01f036cd63) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_394b6387dbdf916e27176e01f036cd63, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_394b6387dbdf916e27176e01f036cd63->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_394b6387dbdf916e27176e01f036cd63, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_394b6387dbdf916e27176e01f036cd63,
        type_description_1
    );


    // Release cached frame if used for exception.
    if (frame_394b6387dbdf916e27176e01f036cd63 == cache_frame_394b6387dbdf916e27176e01f036cd63) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_394b6387dbdf916e27176e01f036cd63);
        cache_frame_394b6387dbdf916e27176e01f036cd63 = NULL;
    }

    assertFrameObject(frame_394b6387dbdf916e27176e01f036cd63);
...
static PyObject *impl_scipy$integrate$quadpack$$$function__2___getattr__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = HAS_ERROR_OCCURRED(tstate);
#endif
    ...
    struct Nuitka_FrameObject *frame_31f00f2dd5739ea1220896d79e534157;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    ...
    PyObject *tmp_return_value = NULL;
    static struct Nuitka_FrameObject *cache_frame_31f00f2dd5739ea1220896d79e534157 = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_31f00f2dd5739ea1220896d79e534157)) {
        Py_XDECREF(cache_frame_31f00f2dd5739ea1220896d79e534157);

#if _DEBUG_REFCOUNTS
        if (cache_frame_31f00f2dd5739ea1220896d79e534157 == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_31f00f2dd5739ea1220896d79e534157 = MAKE_FUNCTION_FRAME(tstate, codeobj_31f00f2dd5739ea1220896d79e534157, module_scipy$integrate$quadpack, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    assert(cache_frame_31f00f2dd5739ea1220896d79e534157->m_type_description == NULL);
    frame_31f00f2dd5739ea1220896d79e534157 = cache_frame_31f00f2dd5739ea1220896d79e534157;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_31f00f2dd5739ea1220896d79e534157);
    assert(Py_REFCNT(frame_31f00f2dd5739ea1220896d79e534157) == 2);
    ...
    branch_yes_1:;
    {
        ...
        frame_31f00f2dd5739ea1220896d79e534157->m_frame.f_lineno = 24;
    ...
    branch_no_1:;
    {
        ...
        frame_31f00f2dd5739ea1220896d79e534157->m_frame.f_lineno = 28;
        {
    ...
    }
    {
        ...
        tmp_expression_value_2 = GET_STRING_DICT_VALUE(moduledict_scipy$integrate$quadpack, (Nuitka_StringObject *)mod_consts[11]);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_31f00f2dd5739ea1220896d79e534157, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_31f00f2dd5739ea1220896d79e534157->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_31f00f2dd5739ea1220896d79e534157, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_31f00f2dd5739ea1220896d79e534157,
        type_description_1,
        par_name
    );
    ...
    // Release cached frame if used for exception.
    if (frame_31f00f2dd5739ea1220896d79e534157 == cache_frame_31f00f2dd5739ea1220896d79e534157) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_31f00f2dd5739ea1220896d79e534157);
        cache_frame_31f00f2dd5739ea1220896d79e534157 = NULL;
    }

    assertFrameObject(frame_31f00f2dd5739ea1220896d79e534157);
...
static PyObject *MAKE_FUNCTION_scipy$integrate$quadpack$$$function__1___dir__() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_394b6387dbdf916e27176e01f036cd63,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
static PyObject *MAKE_FUNCTION_scipy$integrate$quadpack$$$function__2___getattr__() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_31f00f2dd5739ea1220896d79e534157,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_33253e98aabcee15fdc115128557f81d;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    bool tmp_result;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    ...
    frame_33253e98aabcee15fdc115128557f81d = MAKE_MODULE_FRAME(codeobj_33253e98aabcee15fdc115128557f81d, module_scipy$integrate$quadpack);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_33253e98aabcee15fdc115128557f81d);
    assert(Py_REFCNT(frame_33253e98aabcee15fdc115128557f81d) == 2);
    ...
    }
    {
        ...
        frame_33253e98aabcee15fdc115128557f81d->m_frame.f_lineno = 5;
    ...
    }
    {
        ...
        frame_33253e98aabcee15fdc115128557f81d->m_frame.f_lineno = 6;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_33253e98aabcee15fdc115128557f81d, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_33253e98aabcee15fdc115128557f81d->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_33253e98aabcee15fdc115128557f81d, exception_lineno);
    }



    assertFrameObject(frame_33253e98aabcee15fdc115128557f81d);
