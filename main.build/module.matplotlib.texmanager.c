...
static void createModuleCodeObjects(void) {
    ...
    codeobj_2b536fa39be8cc1830d307285357a55b = MAKE_CODE_OBJECT(module_filename_obj, 103, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[12], mod_consts[12], mod_consts[223], NULL, 1, 0, 0);
...
static PyObject *impl_matplotlib$texmanager$$$function__2___new__(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_2b536fa39be8cc1830d307285357a55b)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_2b536fa39be8cc1830d307285357a55b = MAKE_FUNCTION_FRAME(tstate, codeobj_2b536fa39be8cc1830d307285357a55b, module_matplotlib$texmanager, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_2b536fa39be8cc1830d307285357a55b);
