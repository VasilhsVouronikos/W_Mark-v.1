...
static PyObject *impl_jinja2$debug$$$function__1_rewrite_traceback_stack(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_f9e6996f9ba05f1b51b5765474799fca = MAKE_FUNCTION_FRAME(tstate, codeobj_f9e6996f9ba05f1b51b5765474799fca, module_jinja2$debug, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_f9e6996f9ba05f1b51b5765474799fca);
...
static PyObject *impl_jinja2$debug$$$function__2_fake_traceback(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_788a6fbe3c615b10b5746dd7b4c37c14)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_788a6fbe3c615b10b5746dd7b4c37c14 = MAKE_FUNCTION_FRAME(tstate, codeobj_788a6fbe3c615b10b5746dd7b4c37c14, module_jinja2$debug, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_788a6fbe3c615b10b5746dd7b4c37c14);
...
static PyObject *impl_jinja2$debug$$$function__3_get_template_locals(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_2bb37a2a1cecd34a4b6b4d6cf11a37f5)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_2bb37a2a1cecd34a4b6b4d6cf11a37f5 = MAKE_FUNCTION_FRAME(tstate, codeobj_2bb37a2a1cecd34a4b6b4d6cf11a37f5, module_jinja2$debug, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_2bb37a2a1cecd34a4b6b4d6cf11a37f5);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_f03c63fb3146b7f62ab76685300cf8cc);
    ...
    }
    {
        ...
        tmp_subscript_value_3 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_1 = LOOKUP_ATTRIBUTE(tstate, tmp_expression_value_7, mod_consts[89]);
            if (tmp_tuple_element_1 == NULL) {
                assert(HAS_ERROR_OCCURRED(tstate));
        ...
        tmp_annotations_3 = _PyDict_NewPresized( 2 );
        {
            ...
            tmp_subscript_value_4 = MAKE_TUPLE_EMPTY(2);
            {
                ...
                tmp_tuple_element_2 = LOOKUP_ATTRIBUTE(tstate, tmp_expression_value_10, mod_consts[89]);
