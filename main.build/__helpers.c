...
PyObject *CALL_FUNCTION_WITH_POSARGS18(PyThreadState *tstate, PyObject *called, PyObject *pos_args) {
    assert(PyTuple_CheckExact(pos_args));
    assert(PyTuple_GET_SIZE(pos_args) == 18);
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        if (is_compiled_function) {
                            ...
                            result = CALL_FUNCTION_WITH_POSARGS18(tstate, init_method, pos_args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_POSARGS19(PyThreadState *tstate, PyObject *called, PyObject *pos_args) {
    assert(PyTuple_CheckExact(pos_args));
    assert(PyTuple_GET_SIZE(pos_args) == 19);
    PyObject *const *args = &PyTuple_GET_ITEM(pos_args, 0);
    CHECK_OBJECT(called);
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        if (is_compiled_function) {
                            ...
                            result = CALL_FUNCTION_WITH_POSARGS19(tstate, init_method, pos_args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_POSARGS89(PyThreadState *tstate, PyObject *called, PyObject *pos_args) {
    assert(PyTuple_CheckExact(pos_args));
    assert(PyTuple_GET_SIZE(pos_args) == 89);
    PyObject *const *args = &PyTuple_GET_ITEM(pos_args, 0);
    CHECK_OBJECT(called);
     CHECK_OBJECTS(args, 89); 
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 89 == function->m_args_positional_count){
            for (Py_ssize_t i = 0; i < 89; i++) {
                Py_INCREF(args[i]);
            }
            result = function->m_c_code(tstate, function,  (PyObject **)args );
        } else if (function->m_args_simple && 89 + function->m_defaults_given == function->m_args_positional_count) {
            NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

            memcpy(python_pars, args, 89 * sizeof(PyObject *));
            memcpy(python_pars + 89, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
            ...
            result = Nuitka_CallFunctionPosArgs(tstate, function, args, 89);
        }
        ...
        if (method->m_object == NULL) {
            ...
            PyObject *result = Nuitka_CallFunctionPosArgs(tstate, method->m_function, args, 89);
            ...
            if (function->m_args_simple && 89 + 1 == function->m_args_positional_count) {
                PyObject *python_pars[89 + 1];
                ...
                result = function->m_c_code(tstate, function, python_pars);
            } else if (function->m_args_simple && 89 + 1 + function->m_defaults_given == function->m_args_positional_count) {
                NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

                python_pars[0] = method->m_object;
                Py_INCREF(method->m_object);

                memcpy(python_pars+1, args, 89 * sizeof(PyObject *));
                memcpy(python_pars+1 + 89, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
                ...
                result = Nuitka_CallMethodFunctionPosArgs(tstate, function, method->m_object, args, 89);
            }
        ...
        if (unlikely(flags & METH_NOARGS)) {
            SET_CURRENT_EXCEPTION_TYPE0_FORMAT1(
                PyExc_TypeError,
                "%s() takes no arguments (89 given)",
                ((PyCFunctionObject *)called)->m_ml->ml_name
            );
            return NULL;
        } else if (unlikely(flags & METH_O)) {
            SET_CURRENT_EXCEPTION_TYPE0_FORMAT1(PyExc_TypeError,
                "%s() takes exactly one argument (89 given)",
                 ((PyCFunctionObject *)called)->m_ml->ml_name
            );
            return NULL;
        } else if (flags & METH_VARARGS) {
...
#if PYTHON_VERSION < 0x370
                result = (*(_PyCFunctionFast)method)(self, (PyObject **)args, 89, NULL);
#else
                result = (*(_PyCFunctionFast)method)(self, &pos_args, 89);
#endif
            } else {
                result = (*method)(self, pos_args);
            }
...
#else
        PyObject *result = _PyFunction_Vectorcall(called, args, 89, NULL);
#endif
        CHECK_OBJECT_X(result);
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs(tstate, (struct Nuitka_FunctionObject const *)init_method, obj, args, 89);
                        } else {
                            result = CALL_FUNCTION_WITH_POSARGS89(tstate, init_method, pos_args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
        ...
        if (likely(func != NULL)) {
            PyObject *result = func(called, args, 89, NULL);
...
PyObject *CALL_FUNCTION_WITH_POSARGS91(PyThreadState *tstate, PyObject *called, PyObject *pos_args) {
    assert(PyTuple_CheckExact(pos_args));
    assert(PyTuple_GET_SIZE(pos_args) == 91);
    PyObject *const *args = &PyTuple_GET_ITEM(pos_args, 0);
    CHECK_OBJECT(called);
     CHECK_OBJECTS(args, 91); 
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 91 == function->m_args_positional_count){
            for (Py_ssize_t i = 0; i < 91; i++) {
                Py_INCREF(args[i]);
            }
            result = function->m_c_code(tstate, function,  (PyObject **)args );
        } else if (function->m_args_simple && 91 + function->m_defaults_given == function->m_args_positional_count) {
            NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

            memcpy(python_pars, args, 91 * sizeof(PyObject *));
            memcpy(python_pars + 91, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
            ...
            result = Nuitka_CallFunctionPosArgs(tstate, function, args, 91);
        }
        ...
        if (method->m_object == NULL) {
            ...
            PyObject *result = Nuitka_CallFunctionPosArgs(tstate, method->m_function, args, 91);
            ...
            if (function->m_args_simple && 91 + 1 == function->m_args_positional_count) {
                PyObject *python_pars[91 + 1];
                ...
                result = function->m_c_code(tstate, function, python_pars);
            } else if (function->m_args_simple && 91 + 1 + function->m_defaults_given == function->m_args_positional_count) {
                NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

                python_pars[0] = method->m_object;
                Py_INCREF(method->m_object);

                memcpy(python_pars+1, args, 91 * sizeof(PyObject *));
                memcpy(python_pars+1 + 91, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
                ...
                result = Nuitka_CallMethodFunctionPosArgs(tstate, function, method->m_object, args, 91);
            }
        ...
        if (unlikely(flags & METH_NOARGS)) {
            SET_CURRENT_EXCEPTION_TYPE0_FORMAT1(
                PyExc_TypeError,
                "%s() takes no arguments (91 given)",
                ((PyCFunctionObject *)called)->m_ml->ml_name
            );
            return NULL;
        } else if (unlikely(flags & METH_O)) {
            SET_CURRENT_EXCEPTION_TYPE0_FORMAT1(PyExc_TypeError,
                "%s() takes exactly one argument (91 given)",
                 ((PyCFunctionObject *)called)->m_ml->ml_name
            );
            return NULL;
        } else if (flags & METH_VARARGS) {
...
#if PYTHON_VERSION < 0x370
                result = (*(_PyCFunctionFast)method)(self, (PyObject **)args, 91, NULL);
#else
                result = (*(_PyCFunctionFast)method)(self, &pos_args, 91);
#endif
            } else {
                result = (*method)(self, pos_args);
            }
...
#else
        PyObject *result = _PyFunction_Vectorcall(called, args, 91, NULL);
#endif
        CHECK_OBJECT_X(result);
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs(tstate, (struct Nuitka_FunctionObject const *)init_method, obj, args, 91);
                        } else {
                            result = CALL_FUNCTION_WITH_POSARGS91(tstate, init_method, pos_args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
        ...
        if (likely(func != NULL)) {
            PyObject *result = func(called, args, 91, NULL);
...
PyObject *CALL_FUNCTION_WITH_POSARGS127(PyThreadState *tstate, PyObject *called, PyObject *pos_args) {
    assert(PyTuple_CheckExact(pos_args));
    assert(PyTuple_GET_SIZE(pos_args) == 127);
    PyObject *const *args = &PyTuple_GET_ITEM(pos_args, 0);
    CHECK_OBJECT(called);
     CHECK_OBJECTS(args, 127); 
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 127 == function->m_args_positional_count){
            for (Py_ssize_t i = 0; i < 127; i++) {
                Py_INCREF(args[i]);
            }
            result = function->m_c_code(tstate, function,  (PyObject **)args );
        } else if (function->m_args_simple && 127 + function->m_defaults_given == function->m_args_positional_count) {
            NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

            memcpy(python_pars, args, 127 * sizeof(PyObject *));
            memcpy(python_pars + 127, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
            ...
            result = Nuitka_CallFunctionPosArgs(tstate, function, args, 127);
        }
        ...
        if (method->m_object == NULL) {
            ...
            PyObject *result = Nuitka_CallFunctionPosArgs(tstate, method->m_function, args, 127);
            ...
            if (function->m_args_simple && 127 + 1 == function->m_args_positional_count) {
                PyObject *python_pars[127 + 1];
                ...
                result = function->m_c_code(tstate, function, python_pars);
            } else if (function->m_args_simple && 127 + 1 + function->m_defaults_given == function->m_args_positional_count) {
                NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

                python_pars[0] = method->m_object;
                Py_INCREF(method->m_object);

                memcpy(python_pars+1, args, 127 * sizeof(PyObject *));
                memcpy(python_pars+1 + 127, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
                ...
                result = Nuitka_CallMethodFunctionPosArgs(tstate, function, method->m_object, args, 127);
            }
        ...
        if (unlikely(flags & METH_NOARGS)) {
            SET_CURRENT_EXCEPTION_TYPE0_FORMAT1(
                PyExc_TypeError,
                "%s() takes no arguments (127 given)",
                ((PyCFunctionObject *)called)->m_ml->ml_name
            );
            return NULL;
        } else if (unlikely(flags & METH_O)) {
            SET_CURRENT_EXCEPTION_TYPE0_FORMAT1(PyExc_TypeError,
                "%s() takes exactly one argument (127 given)",
                 ((PyCFunctionObject *)called)->m_ml->ml_name
            );
            return NULL;
        } else if (flags & METH_VARARGS) {
...
#if PYTHON_VERSION < 0x370
                result = (*(_PyCFunctionFast)method)(self, (PyObject **)args, 127, NULL);
#else
                result = (*(_PyCFunctionFast)method)(self, &pos_args, 127);
#endif
            } else {
                result = (*method)(self, pos_args);
            }
...
#else
        PyObject *result = _PyFunction_Vectorcall(called, args, 127, NULL);
#endif
        CHECK_OBJECT_X(result);
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs(tstate, (struct Nuitka_FunctionObject const *)init_method, obj, args, 127);
                        } else {
                            result = CALL_FUNCTION_WITH_POSARGS127(tstate, init_method, pos_args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
        ...
        if (likely(func != NULL)) {
            PyObject *result = func(called, args, 127, NULL);
...
PyObject *CALL_FUNCTION_WITH_ARGS15_KWSPLIT(PyThreadState *tstate, PyObject *called, PyObject *const *args, PyObject *const *kw_values, PyObject *kw_names) {
     CHECK_OBJECTS(args, 15); 
