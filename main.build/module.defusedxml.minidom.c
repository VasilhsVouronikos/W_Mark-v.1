...
static void createModuleCodeObjects(void) {
    ...
    codeobj_d3bbc1f8dc5b1f03b5fbd05b70630823 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[35], mod_consts[35], NULL, NULL, 0, 0, 0);
    codeobj_6d7bf0069c8b75c377901018164f65d0 = MAKE_CODE_OBJECT(module_filename_obj, 17, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[1], mod_consts[1], mod_consts[36], NULL, 6, 0, 0);
    codeobj_b6251c3328997c19608acb4990145d90 = MAKE_CODE_OBJECT(module_filename_obj, 42, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[11], mod_consts[11], mod_consts[37], NULL, 5, 0, 0);
}
...
static PyObject *impl_defusedxml$minidom$$$function__1_parse(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_6d7bf0069c8b75c377901018164f65d0 = MAKE_FUNCTION_FRAME(tstate, codeobj_6d7bf0069c8b75c377901018164f65d0, module_defusedxml$minidom, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_6d7bf0069c8b75c377901018164f65d0);
...
static PyObject *impl_defusedxml$minidom$$$function__2_parseString(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_b6251c3328997c19608acb4990145d90)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_b6251c3328997c19608acb4990145d90 = MAKE_FUNCTION_FRAME(tstate, codeobj_b6251c3328997c19608acb4990145d90, module_defusedxml$minidom, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_b6251c3328997c19608acb4990145d90);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_d3bbc1f8dc5b1f03b5fbd05b70630823);
